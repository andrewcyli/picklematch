  ...
  return <nav className="fixed bottom-0 left-0 right-0 bg-background border-t border-border shadow-lg">
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex items-center justify-around py-3">
          <button onClick={() => onSectionChange("setup")} disabled={disabled} className={cn("flex flex-col items-center gap-1 px-6 py-2 rounded-lg transition-all", activeSection === "setup" ? "text-primary bg-primary/10" : "text-muted-foreground hover:text-foreground hover:bg-muted/50", disabled && "opacity-50 cursor-not-allowed")}>
